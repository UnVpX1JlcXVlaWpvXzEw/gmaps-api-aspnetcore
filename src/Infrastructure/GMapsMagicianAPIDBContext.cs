// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GMapsMagicianAPIDBContext.cs" company="ApexAlgorithms">
//     Copyright (c) ApexAlgorithms. All rights reserved.
// </copyright>
// <summary>
// GMapsMagicianAPIDBContext
// </summary>
// ----------------------------------------------------------------------------------------------------------------
...
namespace GMapsMagicianAPI.Infrastructure
{
    ...
    /// <summary>
    /// <see cref="GMapsMagicianAPIDBContext"/>
    /// </summary>
    /// <seealso cref="DbContext"/>
    /// <seealso cref="IUnitOfWork"/>
    public class GMapsMagicianAPIDBContext : DbContext, IUnitOfWork
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GMapsMagicianAPIDBContext"/> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        /// <param name="mediator">The mediator.</param>
        /// <param name="options">The options.</param>
        public GMapsMagicianAPIDBContext(
            IConfiguration configuration,
            IMediator mediator,
            DbContextOptions<GMapsMagicianAPIDBContext> options)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder
                ...
                .UseMySql(
                    this.configuration.GetSection(GMapsMagicianAPIDBContext.DatabaseConnectionSection).Value,
