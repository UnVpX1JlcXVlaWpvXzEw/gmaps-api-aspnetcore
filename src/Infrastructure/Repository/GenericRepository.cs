// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GenericRepository.cs" company="ApexAlgorithms">
...
namespace GMapsMagicianAPI.Infrastructure.Repository
{
            ...
            where Entity : EntityBase
    {
        ...
        /// The context
        /// </summary>
        protected readonly GMapsMagicianAPIDBContext Context;
        ...
        public GenericRepository(GMapsMagicianAPIDBContext context)
        {
